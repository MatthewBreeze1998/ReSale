...
namespace Cloud_System_dev_ops.Repo
{
...

    {
        ...
        public FakeReSaleRepo()
        {
            ...
            {
                new ReSaleModel() {ProductId = 1,CurrentPrice = 123.12, CreationTime = new DateTime(2019,09,10,11,40,28)},
                new ReSaleModel() {ProductId = 2,CurrentPrice= 11.4,  CreationTime = new DateTime(2019,09,14,10,40,28)},
                new ReSaleModel() {ProductId = 2,CurrentPrice = 341.41, CreationTime =new DateTime(2019,09,20,9,40,28)}
            };// data
        }
